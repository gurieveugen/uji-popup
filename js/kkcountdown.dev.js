...
(function($){
    $.fn.kkcountdown = function(options) {
            ...
            function kkCountDown(oneDay, obj, count){
	            ...
	            if( minuty > 0)  {obj.find('.kkc-min').show(); obj.find('.kkc-min').html(minuty); obj.find('.kkc-min-text').show(); } //uji addon
				if( minuty == '00') { obj.find('.kkc-min-text').hide(); obj.find('.kkc-min').hide();}//uji addon
